# Using Polymorphism to Build an HTML Generator in Python video
...
# Building Polymorphic Functions in Python video
...
heading = Heading('My Amazing Heading') #no comma will throw an error
